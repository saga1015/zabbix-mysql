...
# v0.1 20170420
#
# Configuration Backup for Zabbix 3.2 MySQL
#
# Origin Author: Ricardo Santos (rsantos at gmail.com)
# http://zabbixzone.com
#
...
# target path
MAINDIR="/usr/local/etc/zabbix/backupconf"
if [ ! -d $MAINDIR ]; then
    ${MKDIRBIN} -p $MAINDIR
fi
